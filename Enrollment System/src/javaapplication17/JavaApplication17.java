...
public class JavaApplication17 {
    ...
    public static String name, gender, address, searchbyName;
    ...
    private void option()
    {
        System.out.print("\n--------------------------------------"
                        ...
                        + "\n--------------------------------------"
                        + "\n1. New Voter: " 
                        + "\n2. Print all Voter List: "
                        + "\n3. Search Voter by Name: "
                        + "\n4. Remove Voter by Id: "
                        + "\n5. Exit: "
                        + "\n   Enter here: ");
    }
    //Input method
    ...
    {
        System.out.println("F I L L  U P  T H E  F O L L O W I N G");
            System.out.println("");
        ...
        Students students = new Students(id, name, gender, age, address);
        return students;
    }
    ...
    public static void mainFuntion()
    {
        ...
        JavaApplication17 er = new JavaApplication17();
